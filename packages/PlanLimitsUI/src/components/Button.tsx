...
export const buttonClasses = tv({
  base: 'rounded-md text-sm text-center shadow-sm focus-visible:outline focus-visible:outline-indigo-dye focus-visible:outline-2 focus-visible:outline-offset-2',
  variants: {
    color: {
