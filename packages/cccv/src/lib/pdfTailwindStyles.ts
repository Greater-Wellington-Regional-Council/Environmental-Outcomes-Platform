...
export const pdfTailwindStyles = {
  ...
  h5: "font-sans font-bold text-[14px] leading-6",
  h6: "font-sans font-bold text-[12px] leading-6",
  h7: "font-sans font-bold text-[10px] leading-6",
  h8: "font-sans font-normal text-[10px] leading-6",
