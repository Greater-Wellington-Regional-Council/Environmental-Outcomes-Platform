...
export default function MapPage() {
    ...
    useEffect(() => {
        console.log('fetching FMU')
        fetchFmu().then().catch((e) => console.error(e))
    ...
    // Combine tangata whenua sites from all selected FMUs
                ...
                <div className={`map-panel relative`}>
                    ...
                    {selectedFmu && selectedFmu.length > 0 && (
                        <SlidingPanel
                            ...
                            {selectedFmu && selectedFmu.length > 0 && (
                                <FreshwaterManagementUnit key={0} {...selectedFmu[0]} mapImage={mapSnapshot} links={{
