...
test.skip('Happy path - select an FMU, check for Tangata Whenua site and change map style', async ({ page }) => {
  ...
  await expect(page.getByTestId('Te Ahikouka, Ruamāhanga River')).toBeVisible()
