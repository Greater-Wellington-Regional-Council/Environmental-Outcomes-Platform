...
class FreshwaterManagementUnitsControllerTest {
    ...
    @MockBean
    private lateinit var twService: TangataWhenuaSiteService
    ...
    fun `Get freshwater-management-units-lng-lat`() {
        ...
        mvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.tangataWhenuaSites.features[0].properties.sites[0]").value("site1"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.tangataWhenuaSites.features[0].properties.sites[1]").value("site2"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.tangataWhenuaSites.features[0].properties.sites[2]").value("site3"))
            .andReturn()
    }
